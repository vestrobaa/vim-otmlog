...
"syn match log_warning 	'\c.*\<\(WARNING\|DELETE\|DELETING\|DELETED\|RETRY\|RETRYING\|DEBUG\|Debug\).*'
"syn match log_keyword 	'\<\(agent\|workflow\)\>'
...
syn match   log_time '\d\d:\d\d:\d\d\.\d\{,3}\s*'
